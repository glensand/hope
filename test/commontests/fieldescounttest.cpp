...
static_assert(hope::compute_field_count_recursive<fields_0>() == 0);
...
static_assert(hope::compute_field_count_recursive<fields_1<int>>() == 1);
static_assert(hope::compute_field_count_recursive<fields_1<bool>>() == 1);
...
static_assert(hope::compute_field_count_recursive<fields_3<int>>() == 3);
static_assert(hope::compute_field_count_recursive<fields_3<bool>>() == 3);
...
static_assert(hope::compute_field_count_recursive<fields_4<int>>() == 4);
static_assert(hope::compute_field_count_recursive< fields_4<bool>>() == 4);
